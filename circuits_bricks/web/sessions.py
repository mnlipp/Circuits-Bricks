...
# A Sessions implementation based on circuits session (3.1) with
# some improvements.
...
from gtk._gtk import SIDE_BOTTOM
...
class Sessions(Component):
    ...
    def __init__(self, name="circuits.session", path="/",
                 channel=channel):
    ...
    def request(self, request, response):
        ...
        response.cookie[self._name]["Path"] = self._path
